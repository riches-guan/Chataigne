	...
	timeAtStartRecord(0)
{
	...
	arm = addBoolParameter("Arm", L"If checked, this will record audio and save it", false);
	autoDisarm = addBoolParameter(L"Auto Disarm", L"If checked, this will automatically set Arm to false when the sequence stops", false);
