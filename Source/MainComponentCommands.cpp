...
*/
	...
	case ChataigneCommandIDs::showAbout:
		result.setInfo(L"关于...", "", "Help", result.readOnlyInKeyEditor);//About
		break;
/*
	case ChataigneCommandIDs::showWelcome:
		result.setInfo(L"Show Welcome Screen...", "", "General", result.readOnlyInKeyEditor);
		break;
...
*/
	...
	case ChataigneCommandIDs::showAbout:
	{
		...
		DialogWindow::showDialog(L"关于", aboutWindow.get(), getTopLevelComponent(), Colours::transparentBlack, true);//About
	}
	break;
/*
	case ChataigneCommandIDs::showWelcome:
	{
		...
		DialogWindow::showDialog(L"欢迎", welcomeScreen.get(), getTopLevelComponent(), Colours::black, true);//Welcome
